function final_output = simulate_all_fast(alpha,beta,sim_length, eps)   %[err_rate,const_a_err,fo_kh_err,mt_err]
...
counter = 0;
ep = zeros(1,t+k); % needs t values ahead, (k-1) values back.
ch_state = 0;
